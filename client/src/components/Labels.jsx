...
export default function Labels({selected, onChange}) {
  ...
  function handleChange(e) {
    ...
    return (
        <>
         <label className="border p-4 flex rounded-2xl gap-2 text-center cursor-pointer">
              ...
              <label className="border p-4 flex rounded-2xl gap-2 text-center cursor-pointer">
                <input type="checkbox" checked={selected.includes('radio')} name="radio" onChange={handleChange}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <label className="border p-4 flex rounded-2xl gap-2 text-center cursor-pointer">
                <input type="checkbox" checked={selected.includes('pets')} name="pets" onChange={handleChange}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <label className="border p-4 flex rounded-2xl gap-2 text-center cursor-pointer">
                <input type="checkbox" checked={selected.includes('private')} name="private" onChange={handleChange}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
